...
object AnikotoFilters {
    ...
    class SortFilter : QueryPartFilter("Sort order", AniKotoFiltersData.SORT)
    class GenreFilter : CheckBoxFilterList("Genre", AniKotoFiltersData.GENRE)
    class SeasonFilter : CheckBoxFilterList("Season", AniKotoFiltersData.SEASON)
    class YearFilter : CheckBoxFilterList("Year", AniKotoFiltersData.YEAR)
    class TypeFilter : CheckBoxFilterList("Type", AniKotoFiltersData.TYPE)
    class StatusFilter : CheckBoxFilterList("Status", AniKotoFiltersData.STATUS)
    class LanguageFilter : CheckBoxFilterList("Language", AniKotoFiltersData.LANGUAGE)
    class RatingFilter : CheckBoxFilterList("Rating", AniKotoFiltersData.RATING)
    ...
    private object AniKotoFiltersData {
        val SORT = listOf(
